...
public class Orion_StarDist2DModel {
    ...
    static final Map<String, Orion_StarDist2DModel> MODELS = new LinkedHashMap<String, Orion_StarDist2DModel>();
    static {
       // MODELS.put(MODEL_DSB2018_PAPER, new Orion_StarDist2DModel(Orion_StarDist2DModel.class.getClassLoader().getResource("models/dsb2018_paper.zip"), 0.417819, 0.5, 8, 48));
        MODELS.put(MODEL_DSB2018_HEAVY_AUGMENTATION, new Orion_StarDist2DModel(Orion_StarDist2DModel.class.getClassLoader().getResource("models/dsb2018_heavy_augment.zip"), 0.479071, 0.3, 16, 96));
        //MODELS.put(MODEL_HE_HEAVY_AUGMENTATION, new Orion_StarDist2DModel(Orion_StarDist2DModel.class.getClassLoader().getResource("models/he_heavy_augment.zip"), 0.692478, 0.3, 16, 96));
    }
    ...
    public Orion_StarDist2DModel(URL url, double probThresh, double nmsThresh, int sizeDivBy, int tileOverlap) {
        this.url = url;
